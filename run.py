...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        query = gr.Textbox(label="Ask a Question about the Report", placeholder="Type your question and press Enter...")
    ...
    clear_button.click(
        fn=clear_current_report,
        outputs=[result, upload, query]
    )
